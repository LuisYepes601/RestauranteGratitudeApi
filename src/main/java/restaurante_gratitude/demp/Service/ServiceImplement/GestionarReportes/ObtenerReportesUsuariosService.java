...
import restaurante_gratitude.demp.Service.GestionReportes.ObtenerReportesUsuario;
 ...
 */
@Service
public class ObtenerReportesUsuariosService implements ObtenerReportesUsuario {

    private UsuarioRepository usuarioRepo;
    private EstilosCeldasServices estiloCeldas;

    @Autowired
    public ObtenerReportesUsuariosService(UsuarioRepository usuarioRepo, EstilosCeldasServices estiloCeldas) {
